...
try{
 ...
 await slide(58);await synced(reopened,58);ok(await reopened.locator('#next').isDisabled(),'End boundary disables Next');await slide(0);await synced(reopened,0);ok(await reopened.locator('#previous').isDisabled(),'Start boundary disables Previous');
