...
Lightweight `/li:role-activate` loads ~500 tokens; deep-dive loads the rest.
...
- **Loading deep-dive at session start** — too heavy. Use `/li:role-activate` for session start.
