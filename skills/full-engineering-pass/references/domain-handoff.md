...
This is the P09 **data-core** interface, not a released domain workflow. It neither
invokes TA/DA/SC/DH/TQ nor replaces the selected work-map reader, lifecycle ledger,
task/package parser or host permission system. The five module procedures, P08
workflow binding and installed-resource wiring remain separately gated.
...
actors and data. Copied-source cases are not installed-adapter acceptance. Native
role demonstrations, P08 grouping/warming/resume, module procedures, cold workflow
continuation, installed-resource closure and P11/P12 consumers remain pending.
The separate twelve documentary/illustrative role checks retain their narrower label.
