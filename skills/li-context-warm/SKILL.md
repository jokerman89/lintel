...
- When context budget is tight without `/lintel:li-context-cool` first
...
To cool / drop: /lintel:li-context-cool
To save state: /lintel:li-context-snapshot
```
...
- **Budget overrun**: REFUSE, recommend `/lintel:li-context-cool` first
