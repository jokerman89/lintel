...
AskUserQuestion:
- A) APPROVED — proceed to next phase (or to /lintel:li-plan if standalone)
...
- Standalone: operator types `/lintel:li-define` to brainstorm
...
**Triggers:**
- `/lintel:li-plan` next (if not in /lintel:li-cycle)
- In `/lintel:li-cycle`, proceeds to DISCOVER
