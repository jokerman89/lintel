...
- Existing gbrain setup working fine — `/sync-brain` is what you actually want
...
✓ Source pinned. /sync-brain to refresh later.
```

**Remote (shared) brain:**
```
> /setup-brain --mode remote-http --remote-url https://brain.example.com
...
- `/sync-brain` — refresh the index after this skill set things up
