...
Invoke `/lintel:li-plan-eng-review` skill (or inline equivalent).
...
If design doc indicates UI/frontend work, invoke `/lintel:li-plan-design-review`:
- Design system implications
- Accessibility considerations
- Visual sketch (if needed) via `/lintel:li-design-html` or `/lintel:li-design-review`

Add design tasks to plan.

### Step 4 — Plan-devex-review (always)

Invoke `/lintel:li-plan-devex-review`:
...
If plan-eng-review / plan-design-review / plan-devex-review surface conflicts or gaps, invoke `/lintel:li-plan-tune` to reconcile.
...
**Generated by:** /lintel:li-plan on <date>
**Status:** APPROVED
**Design doc:** <path>
...
YES — operator can /lintel:li-plan with existing APPROVED design doc.
