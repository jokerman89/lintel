...
- Want to switch to different role — use `/lintel:li-role-rotate`
...
To re-activate same role: /lintel:li-role-activate <id>
To activate different role: /lintel:li-role-activate <other>
```
