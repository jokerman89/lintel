...
2. points at `docs/audit/uniformity-matrix.md` — the living dashboard regenerated by
   `bin/li-uniformity`.
...
MATRIX="$REPO_ROOT/docs/audit/uniformity-matrix.md"
...
case "$mode" in
  matrix)
    if [ -f "$MATRIX" ]; then
      ...
      echo "_Full matrix: docs/audit/uniformity-matrix.md_"
    else
  ...
  *)
    bash "$REPO_ROOT/tests/shape/uniformity-coverage.sh"
    echo ""
    echo "Living dashboard: docs/audit/uniformity-matrix.md (regenerate: bin/li-uniformity)"
...
- `docs/audit/uniformity-matrix.md` (the living dashboard)
...
- `docs/audit/lintel-uniformity-MASTER.md` (the original top-20 findings)
