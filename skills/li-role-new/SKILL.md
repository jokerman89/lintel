...
- One-off persona — use `/lintel:li-role-activate` with light operator-context instead
...
Examples:
- `/lintel:li-exec-brief` (Field CTO works well with)
- `FieldCTOAdvisor` agent
- `/lintel:li-proposal-drafter`
...
If Y: `/lintel:li-role-activate <id>`.
