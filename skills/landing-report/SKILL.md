...
- Phase 3 (20 MS-specific skills) — blocked on /jstack-eval, T0 corpus now ready
...
- **Trailblazer-voice requested but T0 corpus empty:** WARN — generation will be best-effort but UNCALIBRATED. Recommend running `/jstack-eval` against corpus before downstream distribution.
