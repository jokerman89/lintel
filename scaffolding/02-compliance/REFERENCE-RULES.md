...
**Relevance for JStack:**
- The six principles structure `/rai-impact-assessment`
- Sensitive Uses categories from RAIS feed `/sensitive-use-report`
- One RAI submission process (`/onerai-prep`) maps to RAIS clearance
...
**Relevance for JStack:**
- DPIA process (`/dpia-prep`) maps to Privacy framework
...
**Relevance for JStack:**
- `/entra-agent-id-prep` produces submissions for this framework
...
**Distinct from `/dsb-prep`:** the skill produces a submission; this doc explains what reviewers look for.

**Relevance for JStack:**
- Informs `/dsb-prep`'s field set + review-perspective pushbacks
...
**Distinct from `TRAILBLAZER-VOICE.md` in this repo:** that file is the operationalized summary; this reference points at the canonical source.

**Relevance for JStack:**
- TRAILBLAZER-CORPUS.md draws verdicts from this source
- TRAILBLAZER-TEST.md applies this rubric
