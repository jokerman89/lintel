...
- `scaffolding/02-compliance/HARD-RULES.md` (Phase 6) — the 5 always-on rules; hooks are an implementation layer for some of these
- `scaffolding/02-compliance/ON-DEMAND-RULES.md` (Phase 6) — the 7 on-demand items
- `/compliance-gate` skill — operator-driven checklist that complements (not replaces) hooks
