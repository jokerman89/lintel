...
**Status:** READY for `/li:eval` against `OurVoice-test.md`. T0 unblocked. Phase 3 can start.

---

## Operator workflow (post-population)

1. **Run `/li:eval`** (Phase 8 skill — to be written) against this corpus. The eval applies OurVoice-test.md per-paragraph and compares verdict to `verdict_label`.
