...
```
> /dsb-prep --share-name internal-research-export --system src/analytics/research_export.py
...
- `/compliance-gate` Item 5 — surfaces DSB requirement
- `/dpia-prep` — complementary for personal data
- `/onerai-prep` — if AI is involved in the data processing
