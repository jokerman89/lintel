...
- For customer-facing AI: cross-link to `/onerai-prep` (DPIA + One RAI together for AI processing personal data).
...
**New system DPIA:**
```
> /dpia-prep --system case-intake --source docs/design/case-intake-flow.md
...
**Bi-regime (GDPR + CCPA):**
```
> /dpia-prep --system marketing-segmentation --regime both
...
- `/compliance-gate` Item 6 — surfaces DPIA requirement
- `/onerai-prep` — for AI processing personal data
- `/dsb-prep` — for personal data sharing scenarios
- `/transparency-doc-gen` — customer-facing privacy notice complementary to DPIA
