...
This is the eval prompt for `/customer-voice-check`. Run it against any customer-facing or official-communication paragraph (input) to get a structured verdict against Microsoft Our Voice guidelines.
...
```bash
# After install + Phase 1: /customer-voice-check skill runs this eval against any provided paragraph
...
#   4. Record result in TRAILBLAZER-CALIBRATION.md
```
