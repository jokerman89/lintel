...
- AI-tell vocabulary (`delve`, `crucial`, `robust`, `comprehensive`, `multifaceted` — see [TRAILBLAZER-CORPUS.md](TRAILBLAZER-CORPUS.md) for full Tier 1/2/3 lists)
...
- **TRAILBLAZER-CORPUS.md** — 60 sanitized paragraphs, 12 cells × ≥2 known-good + ≥2 known-bad
- **TRAILBLAZER-TEST.md** — eval rubric applied per paragraph
- **TRAILBLAZER-CALIBRATION.md** — per-cell accuracy of the rubric vs. operator verdict
- **`/customer-voice-check` skill** — gate before customer distribution
...
- [TRAILBLAZER-CORPUS.md](TRAILBLAZER-CORPUS.md) — calibration anchor + vocab lists
- [TRAILBLAZER-TEST.md](TRAILBLAZER-TEST.md) — eval prompt
- [TRAILBLAZER-CALIBRATION.md](TRAILBLAZER-CALIBRATION.md) — current accuracy
- [TRAILBLAZER-EXAMPLES.md](TRAILBLAZER-EXAMPLES.md) — distilled examples per technique
