# AGT Overview — Agent Governance for Lintel

Summary of Microsoft Agent Governance (AGT) as it applies to Lintel-built agents.
...
## When AGT applies to a Lintel agent
...
## Most Lintel agents are NOT AGT-scope

The 40 agents shipped in Lintel Phase 4 are mostly READ-ONLY subagents invoked by the main Claude Code session. They:
...
## When Lintel-built agents DO need AGT

A Lintel-built agent needs AGT registration when the operator productizes it into:
...
These are typically NOT what Lintel agents are. They're what an operator BUILDS using Lintel's planning + design skills.

## How Lintel supports AGT readiness
...
## Key concepts (terms appearing across Lintel)
