...
Run via `/onecs-check` skill (operator-triggered). Surface checklist; operator confirms each item.
...
Hooks are OPT-IN. Operator manually symlinks chosen hooks into `~/.claude/hooks/`. See `02-sdl/hooks/README.md`.
