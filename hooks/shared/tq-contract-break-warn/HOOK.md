...
fires_on: edit to a provider file (matching pack.testing_qa.provider_glob OR identified by .claude/runtime/state/tq/contract-test-suite-*.md) without paired contract-test update
