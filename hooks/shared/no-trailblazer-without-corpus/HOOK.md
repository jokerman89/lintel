...
Operator may have a deadline + need to produce trailblazer-tagged DRAFT before full calibration. Output carries UNCALIBRATED stamp; downstream `/rais-customer-voice-check` refuses to certify.
