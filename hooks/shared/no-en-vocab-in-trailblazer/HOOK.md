...
## Tier 1 vocab (from OurVoice-corpus.md)
...
The companion enforcement happens at `/rais-customer-voice-check` (which blocks distribution) and `/msvoice-rewrite` (which regenerates paragraphs hitting Tier 1). This hook surfaces at edit-time for fast feedback.
