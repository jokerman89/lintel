...
substance but skipped the visible contract.

## L-017 — Consume the source's KNOW-HOW; produce the user's VALUE — never port its mechanism
...
Related: [[L-013]] (make-it-ours = reinvent the substance) — L-017 is the sharp instance: reinvent
