...
- v5.3 (2026-06-13): launch-readiness drive folded into PR #73 (feat/v5.3-cli-and-craft → main); suite 82/82. Public-launch items DATED in .claude/engineering/audits/2026-06-12-launch-readiness-register.md §3-B. Repo migrated — knowledge here, runtime gitignored. v5.0 chain #62→#65 merged.
