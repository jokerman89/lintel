...
**Methodology placeholder:** see `.claude/engineering/design-archive/UPSTREAM-SIMILARITY.md` for full method.
...
- No document claims Lintel vendors or fetches third-party code (it does not)
...
# See .claude/engineering/design-archive/T0-CALIBRATION-WORKFLOW.md
...
- `.claude/engineering/design-archive/lintel-v4.0-reframe-design.md` — current architecture
- `.claude/engineering/design-archive/lintel-v3-plan.md` — v3 design (historical)
- `.claude/engineering/design-archive/lintel-v2-design.md` — v2 design (historical)
- `.claude/engineering/design-archive/MIGRATION-TABLE-v2.md` — v1→v2 rename mapping
- `.claude/engineering/design-archive/PLUGIN-FORMAT-RESEARCH.md` — per-CLI plugin schema findings
- `docs/session-harness.md` — full session-harness mental model
- `.claude/engineering/design-archive/T0-CALIBRATION-WORKFLOW.md` — Gate 3 operator workflow
