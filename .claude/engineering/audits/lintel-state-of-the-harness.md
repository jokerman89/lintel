...
The v4.0 reframe (`.claude/engineering/design-archive/lintel-v4.0-reframe-design.md`) frames the system as "one architecture,
...
| `.claude/engineering/evolution/` | evolution log (Gate M1 artifacts) | per structural change |
...
**Evolution log** (`.claude/engineering/evolution/`): Gate-M1 artifacts for structural changes (phase2-packs-
envelope, phase3-nav-forge-wiki, spine-extraction-audit, caip-pack-extraction).

**The v4.9 five-lens remediation** (audit + engineering-reviewed plan in `.claude/engineering/audits/`) was the most
