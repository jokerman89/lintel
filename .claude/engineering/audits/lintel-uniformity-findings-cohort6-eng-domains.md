...
All five domains' *target* depth is specified in `.claude/engineering/design-archive/lintel-v4.0-reframe-design.md` Ch.3 (§3.2 module pattern, §3.3–§3.7 per-domain specs). None of the five modules is built yet:
