...
**Refs:** `.claude/engineering/design-archive/lintel-v4.0-reframe-design.md` v2.0 §1.4 (FR-C navigation), §2.2 (FR-A Brief Forge), §2.4 (FR-C wiki-gen), §5.2 Phase 3
...
- **Extended:** `docs/migrations/_INDEX.md` — adds Phase 3 entries (orientator invocation, brief-forge wiring, wiki-gen pre-commit).
...
**Verdict:** GREEN with one YELLOW note: existing showcase replacement is documented in `docs/migrations/_INDEX.md` so operators know what to expect.
