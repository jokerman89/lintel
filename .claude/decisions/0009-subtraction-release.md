...
files); a 0-reference tail (external-memory setup/sync, WorkshopFacilitator); and a role family of 8
...
3. **0-ref pruning.** External-memory setup and synchronization entries removed (capability was honest-labeled
