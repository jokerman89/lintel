# ADR-0027: First-class swarming as an opt-in execution profile

**Status:** Accepted — 2026-09-08; reconciled under Universal P04 on 2026-09-20.
**Origin:** `275a35447c4ad271e05816ade43ac48f1acec24f`, originally
`.claude/decisions/0026-first-class-swarming.md`. The real merge preserves that decision and
its complete ancestry. Main's [ADR-0026](0026-hybrid-work-packages.md) keeps its number and authority.

## Hybrid reconciliation

Swarming schedules bounded packages, not a fresh implementer/reviewer per short leaf. Package
membership, unchanged leaf IDs, acceptance and dependencies stay in the authoritative plan/tasks;
legacy ungrouped tasks remain singleton packages. Review depth follows aggregate package risk:
substantive work requires a genuinely independent actor; mechanical packages may record coordinator
review. Every leaf still needs evidence, and final integrated review remains separate.

Coordinator-owned authority and project-generated outputs must be protected from worker and
reviewer artifact aliases, not only from write scopes. Worker and reviewer changes are checked
separately. New completion evidence binds an attempt, source acceptance, observable result and
exact reviewed report; preserved historical reports are not upgraded into current evidence.

Brief Forge remains explicit opt-in under ADR-0008. A rich Markdown brief is data in a validated
