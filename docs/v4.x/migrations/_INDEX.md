...
| v5.1-subtraction-aliases | 2026-06-12 | 2026-09-12 | 2026-12-12 | ADR-0009: 35 engineering sub-skills collapsed into module dispatch tables (invoke `/li:<module> <capability>`) + role family 8→3. 41 aliases route the old names until grace ends. Detect: `grep -E 'old: (ta-|da-|sc-|dh-|tq-|role-)' config/aliases.yaml`. |
