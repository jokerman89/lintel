...
**Status:** Standalone feature request (separate from `lintel-v3.6-backlog.md` and `lintel-feature-curated-flow-tracking.md`). Consolidated into v4.0 via [`docs/design/lintel-v4.0-reframe-design.md`](../design/lintel-v4.0-reframe-design.md) Chapter 1.
