...
| 11 top-level .md i root | För många | Flytta 5 design-docs till `docs/design/` |
...
- [ ] Document findings i `docs/per-cli/PLUGIN-FORMAT-RESEARCH.md`
...
- [ ] Move 5 design-docs root → `docs/design/`
