...
- `/li:design-doc-write` — write design doc to `docs/design/lintel-*.md`
...
**Artifacts produced:**
- `docs/design/lintel-<branch>-design-<datetime>.md` — the design doc
...
# → scans cwd + ~/.lintel/scaffolding/ + docs/design/ for ExpressRoute mentions
