...
**Pass:** X2 of 5 (per `docs/audit/lintel-uniformity-audit-prompt.md` §"Cross-component checks")
**Date:** 2026-05-29
...
**Inputs:** cohorts 1-8 findings files; `docs/design/lintel-v4.0-reframe-design.md`; `AGENT-INSTRUCTIONS.md`; spot-checks of `skills/plan/SKILL.md`, `tests/shape/workflow-root-has-navigation.sh`, `lib/pack-resolver.sh`.
