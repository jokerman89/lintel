...
- `docs/audit/` (25 files, this register's own dir) + `docs/feature-requests/` + much of `docs/design/`
  — Swedish + Microsoft-internal residue + harsh self-critique; **should not be in the public tree.**
- `docs/per-cli/PLUGIN-FORMAT-RESEARCH.md` + `docs/session-harness.md` +
  `docs/lintel-state-of-the-harness.md` — v3 MS fossils; the per-cli one teaches the WRONG slug
