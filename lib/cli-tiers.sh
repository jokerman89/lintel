...
#
# cli_tier_field <cli> <field>  -> prints the value. Unknown CLI or missing field
#   returns a SAFE default (tier=best-effort, hooks_supported=false, ...), so a new
#   or unrecognized CLI degrades honestly instead of crashing or over-claiming.
